...
|| typeof process.env.REACT_APP_INFURA !== "string") {
    return console.error("env not set");
}

const web3 = new Web3('https://ropsten.infura.io/v3/'+process.env.REACT_APP_INFURA);

// Your Ethereum wallet private key
const privateKey = process.env.REACT_APP_USER_PRIVATE_KEY;
